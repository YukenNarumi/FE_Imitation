...
011171k44400001111121111000010\
01k11124444441k11111000bag0010\
0111kk124442111211100001611110\
011511i13321111110000000001100\
01111113111k1k1220000000011000\
...
std::vector<JobDescription> job_list_ = {
    { "ロード",     (-1, 1, 2,  4, -1, 1, 2, 2) },
    { "パラディン", (-1, 1, 3,  6, -1, 1, 2, 2) },
    { "Sナイト",    (-1, 1, 3, -1, -1, 1, 2, 2) },
    { "Aナイト",    (-1, 1, 2, -1, -1, 1, 2, 2) },
    { "アーチャー", (-1, 1, 3, -1, -1, 1, 2, 2) },
    { "Pナイト",    ( 1, 1, 1,  1,  1, 1, 1, 1) },
    { "海賊",       ( 2, 1, 2,  4, -1, 1, 2, 2) },
    { "ハンター",   (-1, 1, 2,  3, -1, 1, 2, 2) },
    { "盗賊",       (-1, 1, 2,  4, -1, 1, 2, 2) }
};
